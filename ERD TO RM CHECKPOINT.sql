...
-- The Relational Model(https://docs.google.com/document/d/1cp8hj_qGTyPbdK_6bYjPfEtpCLRO80duzWFpU10neP0/edit?usp=sharing)


--2. Implement the relational model using SQL.
--RELATIONAL DATABASE MANAGEMENT
CREATE DATABASE RDM_CP
GO

--ACCESS TO RELATIONAL DATABASE MANAGEMENT DATABASE
USE RDM_CP
Go
...
SELECT First_Name, Last_Name, Region From Producer
WHERE Region = 'Sousse';
